 ...
 *
 */
//class DessertTimer { //without LifeCycle
//A lifecycle is a kotlin object representing the lifecycle like the activity lifecycle
class DessertTimer(lifecycle:Lifecycle):LifecycleObserver {
    ...
    init {
        lifecycle.addObserver(this) //This line of code is to tell that it's going to observe the activity's lifecycle
    }

//    @OnLifecycleEvent(Lifecycle.Event.ON_PAUSE) //We are specifying that whatever the lifecycle is observing goes through ON_PAUSE, dummyMethod is called
//    fun dummyMethod(){
